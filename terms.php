<?php
    $pageTitle = "Terms & Conditions | Conzura Soft Solutions";
    include 'partials/header.php';
?>

<main class="min-h-screen bg-dark-bg text-gray-400 pt-24 pb-16">
    <div class="container mx-auto px-6 max-w-4xl">
        <h1 class="font-display text-5xl font-extrabold text-white mb-6 border-b border-gray-800 pb-4" data-aos="fade-up">Terms & Conditions</h1>
        
        <p class="text-sm italic mb-10" data-aos="fade-up" data-aos-delay="100">
            Last updated on 30-10-2025 17:38:09
        </p>

        <div class="space-y-6 text-lg" data-aos="fade-up" data-aos-delay="200">
            <p>
                These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
                agreement by and between **CONZURA SOFT SOLUTIONS OPC PRIVATE LIMITED** ( “Website
            ...
            <ul class="list-disc list-outside ml-6 space-y-4">
                ...
                <li>
                    ...
                    jurisdiction of the courts in **ANANTAPUR, Andhra Pradesh**.
                </li>
                <li>
